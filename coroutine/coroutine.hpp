 ...
 * @LastEditors: dega
 * @LastEditTime: 2022-10-19 15:21:43
 * @Description: 
 * @FilePath: \design_pattern\coroutine\coroutine.hpp
 */
...
// static std::shared_ptr<derived> get_instance(_args&&... args) {
...
//         if (nullptr == _instace) {
//             _instance = new(std::nothrow) derived(std::forward<_args>(args)...);
